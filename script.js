...
function updateButtons() {
    ...
    if (currentMode === "arrival") {
        document.getElementById("arrivalBtn")
            .classList.add("active-arrival");
    } else {
        document.getElementById("departureBtn")
            .classList.add("active-departure");
    }
    ...
    if (currentShift === "morning") {
        document.getElementById("morningBtn")
            .classList.add("active-morning");
    } else {
        document.getElementById("nightBtn")
            .classList.add("active-night");
    }
}
